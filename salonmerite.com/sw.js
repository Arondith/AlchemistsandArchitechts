(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["salonmerite\\\\.com(?:/.*)?/ola/services/.*","salonmerite\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://a78b45d9-ad73-4131-bb19-6337339729bf\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["salonmerite\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/a78b45d9-ad73-4131-bb19-6337339729bf/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/a78b45d9-ad73-4131-bb19-6337339729bf/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/now-hiring","/reviews-1","/","/book-appointment","/staff"]').map((e => ({
                url: e,
                revision: "1735808733215"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("salonmerite.com-"))).map((e => caches.delete(e))))
            })))
